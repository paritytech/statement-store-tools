...
LABEL io.parity.image.authors="devops-team@parity.io" \
	...
	io.parity.image.source="https://github.com/paritytech/statement-store-tools/blob/${VCS_REF}/docker/dockerfiles/statement-store-tools_injected.Dockerfile" \
	io.parity.image.revision="${VCS_REF}" \
	io.parity.image.created="${BUILD_DATE}" \
	io.parity.image.documentation="https://github.com/paritytech/statement-store-tools/"
